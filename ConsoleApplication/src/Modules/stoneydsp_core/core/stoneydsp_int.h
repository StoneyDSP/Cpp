...
public:
    ...
    ****************************************************************************/
    ...
    inline Int() : value{0}
    {
        ...
        std::cout << this << " - " << typeid(*this).name() << " - Initial Value = " << *this << std::endl;
        std::cout << std::endl;
    }
    ...
    /** Move Constructor. */
    inline Int(Int&& otherValue) noexcept : value{0}
    {
    ...
    inline ~Int() noexcept
    {
        ...
        {
            std::cout << this << " - " << typeid(*this).name() << " - Final Value = " << *this << std::endl;
    ...
    ****************************************************************************/
     ...
     * 
     * @param lhs operand left of the operator.
     * @param rhs operand right of the operator.
     * @returns Integer result of the operation by reference.
    */
    ...
    ****************************************************************************/
     ...
     * @param lhs operand left of the operator.
     * @param rhs operand right of the operator.
     * @returns Integer result of the operation by value.
     * 
    */
    ...
    */
     ...
     * @param lhs operand on left-hand side of the '|' operator.
     * @param rhs operand right of the operator.
     * @returns Int
    */
    friend inline Int operator|(Int lhs, const Int& rhs)
